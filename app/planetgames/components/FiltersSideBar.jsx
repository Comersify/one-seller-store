...
const CategoryItem = ({ active, onClick, name, subCategories }) => {
  return (
    <li className="p-2">
      <div
        onClick={() => onClick()}
        className={`font-bold px-2 py-1 rounded-md ${active && "bg-gray-200"
...
export const FiltersSideBar = ({ setFilter }) => {
  ...
  return (
    <>
      ...
      <div
        id="sidebar"
        className={`transform transition-transform duration-300 flex dur h-screen ${!open && " translate-x-[-256px]"
