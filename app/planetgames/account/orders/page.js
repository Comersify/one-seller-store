...
function Orders() {
  ...
  return (
    <>
      <section className="flex w-full flex-col lg:h-screen text-gray-900 items-center justify-start">
              ...
              <tbody>
                {orders.map((order) => (
                  <tr key={order.id} className="text-center border-b hover:bg-gray-50">
                    ...
                    <td
                      className={`px-4 py-2 border font-semibold ${order.status === "Shipped"
                        ? "text-blue-500"
