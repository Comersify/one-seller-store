      ...
      <div className="w-full max-w-sm mx-auto lg:max-w-md">
        <div className="mx-auto bg-gray-100 rounded relative">
          <img
            ...
            className="w-full h-[300px] sm:h-[350px] md:h-[400px] lg:h-[350px] object-contain"
          />
        </div>
        ...
        <div className="mt-4 flex justify-center gap-4">
          {images.map((image, index) => (
            <img
              ...
              src={image}
              alt={`Thumb ${index}`}
              className={`w-24 h-24 object-contain  cursor-pointer transition duration-300 ${
                image === selectedImage ? " scale-105" : "border-gray-500"
              }`}
      ...
      <div className="flex-1 p-2 rounded-xl shadow-sm space-y-6 max-w-2xl ml-auto">
        ...
        <div className="bg-white p-4 rounded-lg">
          ...
          <p className="text-gray-600">
            Add funds to your PlayStation® Network wallet without the need for a
            credit card...
          </p>
